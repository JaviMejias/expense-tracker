...
export const SYSTEM_CATEGORIES = ['comida', 'servicios', 'transporte', 'entretencion', 'salud', 'otros']
...
export const appThemes = {
    classic: {
        ...
        themeDot: 'bg-indigo-500 ring-indigo-500/40'
    },
    cyberpunk: {
        id: 'cyberpunk',
        label: 'Cyberpunk Red',
        ...
        themeDot: 'bg-rose-500 ring-rose-500/40'
    },
    mint: {
        id: 'mint',
        label: 'Emerald Mint',
